...
export default function Timeline() {
  ...
  return (
    <div className="relative h-screen overflow-scroll">
      ...
      <div className="w-screen masonry bg-white px-2 mt-2 mb-8">
        {photo.map((item) => (
      ...
      {navbar && (
        <div className="fixed bottom-4 bg-gray-600 h-12 w-9/12 left-1/2 transform -translate-x-1/2 rounded-full"></div>
      )}
    </div>
  );
}
